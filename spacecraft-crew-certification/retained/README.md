...
| File | Superseded | Why |
|---|---|---|
| `source.sha256-303eed8e4cc0.md` | 2026-09-24 | Section 6(4)(c) read "must always satisfy Section 4, regardless of flight hours", which contradicted Section 6(3) and the benchmark copy of the Act. Restored to "unless the applicant qualifies under subsection (3)". |
