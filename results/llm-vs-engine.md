...
>
> Numbers below are from [Simpson, Kozak, Doake 2026](https://github.com/Aethis-ai/confidently-wrong-benchmark/blob/main/paper/Simpson_Exception_Chain_Collapse_2026.md) (v3.13), Table 8b.
>
...
| GPT-5.4 (low reasoning effort, v3.8 replication) | 11/11 (100%) | [74.1%, 100%] | an earlier 7/11 claim was withdrawn in the paper's v3.8 revision (instrumented replication) |
...
- The intra-model reasoning-compute-dependence hypothesis was **withdrawn in v3.8** (no committed script reproduced the original 7/11; instrumented replication returned 11/11). Section 6.9 pre-registers an N=66 replication, not yet run as of v3.13 (July 2026).
- v3.5 of the paper reported GPT-5.3 at 27% (3/11); that figure was traced to a harness configuration issue that cut off some model responses before a visible answer was produced. The corrected value is 63.6%.
