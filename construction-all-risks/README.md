...
This calls the live public API and should pass all 14 scenarios without an API key.
...
curl -X POST https://api.aethis.ai/api/v1/public/decide \
  ...
  -d '{"ruleset_id": "aethis/construction-all-risks", "field_values": {"car.claim.is_rectification": true}}'
```
