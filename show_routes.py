...
def walk_scenario(api_url: str, ruleset_id: str, all_inputs: dict, api_key: str | None = None) -> list:
    ...
    result = decide(api_url, ruleset_id, field_values, api_key=api_key)
...
def main():
    ...
    # Get total fields
    initial = decide(args.url, ruleset_id, {}, api_key=args.api_key)
    ...
    for idx in selected:
        ...
        steps = walk_scenario(args.url, ruleset_id, inputs, api_key=args.api_key)
